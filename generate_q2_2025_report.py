#!/usr/bin/env python3
"""
generate_q2_2025_report.py

Generates the audit report for 1st April 2025 to 30th June 2025 (Q2 2025).
Reads /var/log/prometheus/alertmanager_events.log, queries Prometheus for
hardware specifications, and outputs Alert_Report_2025_04_01_to_2025_06_30.csv.
"""
...
if os.path.exists(LOG_FILE):
    print(f"2. Parsing log file {LOG_FILE} for range 2025-04-01 to 2025-06-30...")
    with open(LOG_FILE, encoding="utf-8", errors="ignore") as f:
        for line in f:
            if not any(d in line for d in ["2025-04-", "2025-05-", "2025-06-"]):
                continue
            line = line.strip()
            if not line:
                continue
...
# 3. Fill missing dates between 2025-04-01 and 2025-06-30 (e.g. 2025-04-01 to 2025-05-06)
print("3. Checking for missing dates in Q2 2025 range...")
