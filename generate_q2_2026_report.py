#!/usr/bin/env python3
"""
generate_q2_2026_report.py

Generates the audit report for 1st April 2026 to 30th June 2026 (Q2 2026).
Reads /var/log/prometheus/alertmanager_events.log, queries Prometheus for
hardware specifications, and outputs Alert_Report_2026_04_01_to_2026_06_30.csv.
"""
...
OUTPUT = "/opt/audit_report/SMC_Alert_Report_2026_04_01_to_2026_06_30.csv"
OUTPUT_FU = "/opt/audit_report/File-upload/SMC_Alert_Report_2026_04_01_to_2026_06_30.csv"
...
def main():
    ...
    if os.path.exists(LOG_FILE):
        print(f"2. Parsing log file {LOG_FILE} for range 2026-04-01 to 2026-06-30...")
        with open(LOG_FILE, encoding="utf-8", errors="ignore") as f:
            for line in f:
                if not any(d in line for d in ["2026-04-", "2026-05-", "2026-06-"]):
                    continue
                line = line.strip()
                if not line:
                    continue
    ...
    # 3. Fill missing dates between 2026-04-01 and 2026-06-30 if any
    print("3. Checking for missing dates in Q2 2026 range...")
