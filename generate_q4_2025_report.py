#!/usr/bin/env python3
"""
generate_q4_2025_report.py

Generates the audit report for 1st October 2025 to 31st December 2025 (Q4 2025).
Reads /var/log/prometheus/alertmanager_events.log, queries Prometheus for
hardware specifications, and outputs Alert_Report_2025_10_01_to_2025_12_31.csv.
"""
...
OUTPUT = "/opt/audit_report/SMC_Alert_Report_2025_10_01_to_2025_12_31.csv"
...
if os.path.exists(LOG_FILE):
    print(f"2. Parsing log file {LOG_FILE} for range 2025-10-01 to 2025-12-31...")
    with open(LOG_FILE, encoding="utf-8", errors="ignore") as f:
        for line in f:
            if not any(d in line for d in ["2025-10-", "2025-11-", "2025-12-"]):
                continue
            line = line.strip()
            if not line:
                continue
...
# 3. Fill missing dates between 2025-10-01 and 2025-12-31 if any
print("3. Checking for missing dates in Q4 2025 range...")
