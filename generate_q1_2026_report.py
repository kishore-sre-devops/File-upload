#!/usr/bin/env python3
"""
generate_q1_2026_report.py

Generates the audit report for 1st January 2026 to 31st March 2026 (Q1 2026).
Reads /var/log/prometheus/alertmanager_events.log, queries Prometheus for
hardware specifications, and outputs Alert_Report_2026_01_01_to_2026_03_31.csv.
"""
...
OUTPUT = "/opt/audit_report/SMC_Alert_Report_2026_01_01_to_2026_03_31.csv"
...
if os.path.exists(LOG_FILE):
    print(f"2. Parsing log file {LOG_FILE} for range 2026-01-01 to 2026-03-31...")
    with open(LOG_FILE, encoding="utf-8", errors="ignore") as f:
        for line in f:
            if not any(d in line for d in ["2026-01-", "2026-02-", "2026-03-"]):
                continue
            line = line.strip()
            if not line:
                continue
...
# 3. Fill missing dates between 2026-01-01 and 2026-03-31 if any
print("3. Checking for missing dates in Q1 2026 range...")
